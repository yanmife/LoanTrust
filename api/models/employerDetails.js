...
const EmployerDetails = {
    ...
    addEmployerDetails: function(EmployerDetails, callback) {
        ...
        return db.query("INSERT INTO employer_details(primary_employer_address, official_email_secondary_employer, resumption_branch, landmark, lga, year_of_employment, idNumber, employmentTime, netMonthlyIncome, user) VALUES(?,?,?,?,?,?,?,?,?,?)", [EmployerDetails.primary_employer_address, EmployerDetails.official_email_secondary_employer, EmployerDetails.resumption_branch, EmployerDetails.landmark, EmployerDetails.lga, EmployerDetails.year_of_employment, EmployerDetails.idNumber, EmployerDetails.employmentTime, EmployerDetails.netMonthlyIncome, EmployerDetails.user, dt], callback);
    },
    ...
    updateEmployerDetails: function(id, EmployerDetails, callback) {
        return db.query("UPDATE employer_details SET primary_employer_address =?, official_email_secondary_employer =?, resumption_branch =?, landmark =?, lga =?, year_of_employment =?, idNumber =?, employmentTime =?, netMonthlyIncome =? WHERE employer_details_id = ?", [EmployerDetails.primary_employer_address, EmployerDetails.official_email_secondary_employer, EmployerDetails.resumption_branch, EmployerDetails.landmark, EmployerDetails.local_government, EmployerDetails.year_of_employment, EmployerDetails.idNumber, EmployerDetails.employmentTime, EmployerDetails.netMonthlyIncome, id], callback);
    }
};
